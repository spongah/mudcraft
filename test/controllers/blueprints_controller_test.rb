...
class BlueprintsControllerTest < ActionController::TestCase
  ...
  test "should create blueprint" do
    assert_difference('Blueprint.count') do
      post :create, blueprint: { data_position: @blueprint.data_position, data_type: @blueprint.data_type, data_value: @blueprint.data_value, map_zone: @blueprint.map_zone }
    end
  ...
  test "should update blueprint" do
    patch :update, id: @blueprint, blueprint: { data_position: @blueprint.data_position, data_type: @blueprint.data_type, data_value: @blueprint.data_value, map_zone: @blueprint.map_zone }
    assert_redirected_to blueprint_path(assigns(:blueprint))
  end
